...
times = [
        ...
        {'block_from': time(10, 45), 'block_to': time(11, 30), 'date': den_d, 'data': {
            ...
            'e112': 'e5aedaf5', # 12 139x Zdeněk Dubnický / Jak si říci o zvýšení platu -  Co dělat pro svůj vysněný plat a jak funguje kompenzace, co nadřízeného potěší a co už méně. 
